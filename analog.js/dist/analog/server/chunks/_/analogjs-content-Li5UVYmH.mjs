import { I as InjectionToken, i as inject, A as ActivatedRoute, T as TransferState, m as makeStateKey, ɵ as __defineDirective, a as __listener, b as __defineInjectable, c as __defineComponent, d as __HostDirectivesFeature, e as __element, f as __classMap, h as __property, j as __viewQuery, k as __queryRefresh, l as __loadQuery, n as __NgOnChangesFeature, o as __pipe, p as __pipeBind1, q as AsyncPipe, D as DOCUMENT, L as Location, R as Router, r as DomSanitizer, N as NgZone, P as PLATFORM_ID, s as isPlatformBrowser, t as assertInInjectionContext, u as DestroyRef, v as PendingTasksInternal, w as __sanitizeHtml, V as ViewContainerRef } from './renderer.mjs';
import { of, Observable, isObservable, firstValueFrom, from } from 'rxjs';
import { map, switchMap, tap, filter, mergeMap, catchError, takeUntil } from 'rxjs/operators';
...
function getSlug(filename) {
  ...
  return (parts == null ? undefined : parts.length) ? parts[4] : "";
}
...
let RenderTaskService = /* @__PURE__ */ (() => {
  let RenderTaskService2 = /* @__PURE__ */ (() => {
    ...
    _pendingTasks = /* @__PURE__ */ new WeakMap();
    ...
    const _MarkedSetupService3 = class _MarkedSetupService3 {
      constructor() {
        ...
        renderer.code = (code, lang) => {
          ...
          if ((_a = this.highlighter) == null ? undefined : _a.augmentCodeBlock) {
            return (_b = this.highlighter) == null ? undefined : _b.augmentCodeBlock(code, lang);
          }
...
function withMarkdownRenderer(options) {
  return [CONTENT_RENDERER_PROVIDERS, (options == null ? undefined : options.loadMermaid) ? [{
  ...
  let AnalogMarkdownComponent2 = /* @__PURE__ */ (() => {
    const _AnalogMarkdownComponent3 = class _AnalogMarkdownComponent3 {
      ...
      getContentSource() {
        ...
        }), filter((content) => typeof content === "string"), mergeMap((contentString) => this.renderContent(contentString)), map((content) => this.sanitizer.bypassSecurityTrustHtml(content)), catchError((e) => of(`There was an error ${e}`)));
      }
      ...
      ngAfterViewChecked() {
        ...
        this.zone.runOutsideAngular(() => {
          var _a;
          return (_a = this.mermaid) == null ? undefined : _a.default.run();
        });
      }
      loadMermaid(mermaidImport) {
        this.zone.runOutsideAngular(() => (
          ...
          from(mermaidImport).pipe(takeUntilDestroyed()).subscribe((mermaid) => {
            ...
            (_a = this.mermaid) == null ? undefined : _a.default.run();
          })
        ));
      }
    };
...
//# sourceMappingURL=analogjs-content-Li5UVYmH.mjs.map
